...
2. Run the associated test harness for a basic check on completeness. A successful run of the test cases
does not guarantee accuracy or fulfillment of the requirements.
Please do not submit your work if test cases fail.
3. Unless explicitly stated, please do not import any additional libraries but feel free to use built-in Python
packages
...
def exercise01():
    ...
    df1 = pd.DataFrame({"Name": ["Dirk Hartog",
                                  "Lauren King",
                                  "Alessandro Mammoli",
                                  "Monique Mammoli",
                                 "Richard Glover"],
...
def exercise04():
    ...
    df4 = pd.DataFrame([{"city": "New York City", "data": 8468000},
                       {"city": "Los Angeles", "data": 3849000},
                       {"city": "Chicago", "data" : 2746388}])
...
def exercise06():
    ...
    df6 = pd.read_excel("data.xlsx", sheet_name = 0, names = ["A", "B", "C"])
